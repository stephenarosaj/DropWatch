...
/**
 * Record to hold information on an Artist Note that when one of these objects is returned via
 * search, all fields are present REFERENCE:
 ...
 * @param genres "A list of the genres the artist is associated with. If not yet classified, the
 *     array is empty."
