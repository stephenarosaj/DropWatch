...
/**
 * Record to hold information on a Track Note that when one of these objects is returned via search,
 * all fields are present (EXCEPT FOR "tracks", since the object returned there is
